		...
		try {
			...
			while (true)
			{
				...
				else if (input.contains("c"))
				{
					...
					System.out.println("Enter auction value:");
					String currentBid = scanner.nextLine();
					System.out.println("When does the auction end? Type in the following format: mm/dd/yyyy with or without the year\n");
					...
					a = new Auction(id, name, Integer.parseInt(currentBid), description, date, username);
					id++;
